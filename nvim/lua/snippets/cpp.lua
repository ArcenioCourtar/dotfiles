return {
	...
	s({trig = "ocf body", snippetType = "snippet", desc = "boilerplate for orthodox canonical form" }, {f(function(args, snip)
		...
		nl("")
		nl(class .. "::" .. class .. "() {")
		nl("	std::cout << \"default " .. class .. " constructor called\" << std::endl;")
		nl("}")
		nl("")
		nl(class .. "::" .. class .. "(const " .. class .. "& other) {")
		nl("	std::cout << \"copy " .. class .. " constructor called\" << std::endl;")
		nl("")
		nl("	*this = other;")
		nl("}")
		nl("")
		nl(class .. "&	" .. class .. "::operator =(const " .. class .. "& other) {")
		nl("	std::cout << \"copy " .. class .. " assignment called\" << std::endl;")
		nl("")
		...
		nl("")
		nl(class .. "::~" .. class .. "() {")
		nl("	std::cout << \"default " .. class .. " destructor called\" << std::endl;")
		nl("}")
		return res
	end)}),
